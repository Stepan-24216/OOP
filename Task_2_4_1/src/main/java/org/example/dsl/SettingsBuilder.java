...
final class SettingsBuilder {
     ...
     */
    void testTimeout(int seconds) {
        settings.setTestTimeoutSeconds(seconds);
    }
     ...
     */
    void gradeThreshold(String grade, int threshold) {
        settings.setGradeThreshold(grade, threshold);
    }
     ...
     */
    void bonus(String githubNick, String taskId, int points) {
        settings.setBonus(githubNick, taskId, points);
    }
